...
**Using autoClose: false with GlobalKey**:

When `autoClose: false`, the widget won't call `onDateSelected` automatically. This works in both Modal and Embedded modes.
